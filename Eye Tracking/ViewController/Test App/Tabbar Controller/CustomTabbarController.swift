...
class CustomTabbarController: UIViewController {
	...
	let tabbarItems = [Item(id: 1, icon: #imageLiteral(resourceName: "Home"), title: "News"),
					   Item(id: 2, icon: #imageLiteral(resourceName: "Home"), title: "Home"),
					   Item(id: 3, icon: #imageLiteral(resourceName: "Home"), title: "Settings")]
